...
export const translations = {
  ar: {
    ...
    ticketsTab: 'الطلبات',
    catalogTab: 'إدارة المنتجات',
    statPending: 'في انتظار الدفع',
    statPreparing: 'جاري التحضير',
    statToday: 'طلبات النهارده',
    showActiveBtn: 'الطلبات الحالية',
    showCompletedBtn: 'المكتملة',
    statusCompleted: 'تم التسليم',
    markCompletedBtn: '✅ تم التسليم',
    priceLabel: 'السعر',
    availableLabel: 'متاح',
    saveLabel: 'حفظ',
    savedLabel: 'تم الحفظ ✓',
  ...
  en: {
    ...
    ticketsTab: 'Orders',
    catalogTab: 'Manage Products',
    statPending: 'Awaiting payment',
    statPreparing: 'Preparing',
    statToday: "Today's orders",
    showActiveBtn: 'Active orders',
    showCompletedBtn: 'Completed',
    statusCompleted: 'Delivered',
    markCompletedBtn: '✅ Mark Delivered',
    priceLabel: 'Price',
